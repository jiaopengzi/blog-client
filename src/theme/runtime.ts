...
function buildThemeCssVariables(palette: ThemePalette, scheme: ThemePreset["scheme"]): string {
    const vars: string[] = [
        ...
        `--jpz-bg-color: ${palette.bg};`,
        `--jpz-bg-color-page: ${palette.bgPage};`,
        `--jpz-bg-color-footer: ${palette.bgFooter};`,
        `--jpz-bg-color-overlay: ${palette.bgOverlay};`,
        `--jpz-border-color: ${palette.border};`,
        `--jpz-border-color-hover: ${palette.borderHover};`,
        ...
        `--jpz-text-color-regular: ${palette.textRegular};`,
        `--jpz-text-color-secondary: ${palette.textSecondary};`,
        `--jpz-text-color-placeholder: ${palette.textPlaceholder};`,
        `--jpz-text-color-disabled: ${palette.textDisabled};`,
        `--jpz-code-block-bg-color: ${palette.codeBlockBg};`,
        `--jpz-code-block-color: ${palette.codeBlockColor};`,
        `--jpz-blockquote-color: ${palette.blockquoteColor};`,
        `--jpz-blockquote-bg-color: ${palette.blockquoteBg};`,
        `--jpz-table-border-color: ${palette.tableBorder};`,
        `--jpz-table-header-bg-color: ${palette.tableHeaderBg};`,
