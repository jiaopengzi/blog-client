/*
 * FilePath    : blog-client-nuxt\src\theme\presets\definitions\tokyonight-night.ts
 * Author      : jiaopengzi
...
export const tokyonightNightPreset: ThemePreset = {
    ...
    palette: {
        ...
        border: "#414868",
        borderHover: "#565f89",
        borderLighter: "#24283b",
        shadowLighter: "0 1px 3px rgba(0, 0, 0, 0.5)",
        shadowLight: "0 3px 6px rgba(0, 0, 0, 0.6)",
        ...
        textDisabled: "#414868",
        codeBlockBg: "#16161e",
        codeBlockColor: "#c0caf5",
        blockquoteColor: "#a9b1d6",
        blockquoteBg: "#1a1b26",
        tableBorder: "#414868",
