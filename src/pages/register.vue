<!--
 * FilePath    : blog-client-nuxt\src\pages\register.vue
 * Author      : jiaopengzi
 * Blog        : https://jiaopengzi.com
 * Copyright   : Copyright (c) 2026 by jiaopengzi, All Rights Reserved.
 * Description : 注册页(CSR, 原 views/register 视图已并入本页面; definePageMeta/useHead 来自原 pages 包装, 逻辑与模板来自原视图)
-->

<!--
 * 补充说明:
 * 保持原 CSR 语义: 整页模板位于 ClientOnly 内, 服务端不渲染注册表单
-->
...
import type { RegisterForm } from "@/components/views/register/types"

definePageMeta({ layout: false, name: "register" })
