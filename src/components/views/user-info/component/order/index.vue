<!--
 * FilePath    : blog-client-nuxt\src\components\views\user-info\component\order\index.vue
 * Author      : jiaopengzi
...
const { editItemDialogVisible, toggleEditDialog, pagination, updateCurrentPage, updatePageSize, editStatus, editItemUpdateDialogVisible } = useBaseTable<
    OrderGetByIDRes,
