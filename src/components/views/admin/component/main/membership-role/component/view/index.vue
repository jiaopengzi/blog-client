<!--
 * FilePath    : blog-client-nuxt\src\components\views\admin\component\main\membership-role\component\view\index.vue
 * Author      : jiaopengzi
 * Blog        : https://jiaopengzi.com
 * Copyright   : Copyright (c) 2025 by jiaopengzi, All Rights Reserved.
 * Description : 会员角色展示组件
-->
...
const timeItems: TimeItem[] = [
    ...
    { value: 60 * 60 * 24 * 30, display: "30天" },
    { value: 60 * 60 * 24 * 90, display: "90天" },
    { value: 60 * 60 * 24 * 180, display: "180天" },
    { value: 60 * 60 * 24 * 365, display: "365天" },
]

const handleClickTimeItem = (item: TimeItem) => {
    viewDataAc.duration_time = item.value
}
