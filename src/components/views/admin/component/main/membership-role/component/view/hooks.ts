/*
 * FilePath    : blog-client-nuxt\src\components\views\admin\component\main\membership-role\component\view\hooks.ts
 * Author      : jiaopengzi
...
interface FormValidationOptions {
    form: {
        ...
        duration_time?: Ref<number | undefined> // 有效时间(秒), 0 表示永久有效
        ...
        status?: Ref<MembershipStatus> // 状态, 1 禁用, 2 启用
