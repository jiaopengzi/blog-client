<!--
 * FilePath    : blog-client-nuxt\src\components\views\admin\component\main\membership-role\index.vue
 * Author      : jiaopengzi
...
<template>
    <section>
        <BaseTable
            ...
            :table-column="cols"
            :route-name="RouteNames.MembershipRole"
        ...
        >
            ...
            <template #category>
                <!-- v-for 循环 membershipCountGroup 生成按钮 -->
