/*
 * FilePath    : blog-client-nuxt\src\components\views\admin\component\main\permission-role\utils.ts
 * Author      : jiaopengzi
 * Blog        : https://jiaopengzi.com
 * Copyright   : Copyright (c) 2025 by jiaopengzi, All Rights Reserved.
 * Description : 权限角色工具函数
 */
...
export function buildUpdateRolesRequest(rolesList: Role[], permissionsData: PermissionRow[]): UpdateRolesRequest {
    return {
        roles: rolesList.map((role): UpdateRoleRequest => ({
