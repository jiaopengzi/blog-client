<!--
 * FilePath    : blog-client-nuxt\src\components\views\admin\component\main\post-category\component\view\index.vue
 * Author      : jiaopengzi
    ...
    <div class="view-page">
        ...
        >
            ...
            <el-form-item label="图片" prop="thumbnail">
                <ImageInput v-model="viewDataAc.thumbnail" placeholder="请输入分类的图片URL-选填" clearable />
            </el-form-item>
...
const emit = defineEmits<{
    (event: "submit-data", value: ViewForm): void // 提交表单数据
}>()
