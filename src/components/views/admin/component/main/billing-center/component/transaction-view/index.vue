<!--
 * FilePath    : blog-client-nuxt\src\components\views\admin\component\main\billing-center\component\transaction-view\index.vue
 * Author      : jiaopengzi
 * Blog        : https://jiaopengzi.com
 * Copyright   : Copyright (c) 2026 by jiaopengzi, All Rights Reserved.
 * Description : 计费中心已注册视图, 包含账号卡片, 交易流水列表及充值/通知/证书弹窗
-->
...
import type { TransactionFlowRes, BillingCenterAccountRes } from "@/api/billingCenter/common"
...
defineOptions({ name: "TransactionView" })
...
const { formatTransactionType, formatRelatedId } = useBillingCenter()
...
/**
 * parseParamsNotLoaded 将 queryParams 解析回对应的响应式变量中 (不需要请求)
 */
...
:deep(.billing-dialog--cert) {
    .el-dialog__header {
        border-bottom-color: var(--jpz-color-warning);
    }
