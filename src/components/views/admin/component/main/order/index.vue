<!--
 * FilePath    : blog-client-nuxt\src\components\views\admin\component\main\order\index.vue
 * Author      : jiaopengzi
...
<template>
    <section>
        ...
        >
            <template #category>
                <!-- v-for 循环 orderCountGroupByStatus 生成按钮 -->
...
const allStatus = OrderStatus.AllStatus
