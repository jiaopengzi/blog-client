/*
 * FilePath    : blog-client-nuxt\src\components\views\admin\component\main\app-option\base\types.ts
 * Author      : jiaopengzi
...
export interface APPOptionForm {
    ...
    carousel_interval: number // 轮播图间隔, 默认 3000, 单位毫秒
    ...
    custom_home_title: string // 自定义网站首页 title
    ...
    footer_qrcode1_enable: boolean // 底部二维码 1 是否开启
    footer_qrcode1: string // 底部二维码 1
    footer_qrcode1_description: string // 底部二维码 1 显示描述

    footer_qrcode2_enable: boolean // 底部二维码 2 是否开启
    footer_qrcode2: string // 底部二维码 2
    footer_qrcode2_description: string // 底部二维码 2 显示描述

    footer_qrcode3_enable: boolean // 底部二维码 3 是否开启
    footer_qrcode3: string // 底部二维码 3
    footer_qrcode3_description: string // 底部二维码 3 显示描述
