<!--
 * FilePath    : blog-client-nuxt\src\components\views\admin\component\main\links\index.vue
 * Author      : jiaopengzi
...
const editRow = (index: number, row: TableData) => {
    // 先重置所有字段, 避免切换行时残留旧数据
    Object.assign(editData, { id: "", name: "", url: "", thumbnail: "", description: "", status: LinkStatusCode.Hidden, order: "" })
