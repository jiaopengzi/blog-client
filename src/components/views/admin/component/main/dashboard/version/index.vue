<!--
 * FilePath    : blog-client-nuxt\src\components\views\admin\component\main\dashboard\version\index.vue
 * Author      : jiaopengzi
...
<template>
    <div class="version-container">
        ...
        <div class="version-client">
            <!-- 安全收敛: 客户端版本为运行时从同源 /VERSION 拉取的 git tag(hooks 内 ref),
                 commit/buildTime 不再暴露(2026-08-28 决策) -->
            <span class="version">客户端版本：{{ versionClient }}</span>
