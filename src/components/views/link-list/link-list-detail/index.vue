<!--
 * FilePath    : blog-client-nuxt\src\components\views\link-list\link-list-detail\index.vue
 * Author      : jiaopengzi
 * Blog        : https://jiaopengzi.com
 * Copyright   : Copyright (c) 2025 by jiaopengzi, All Rights Reserved.
 * Description : 友情链接列表详情
-->
...
import AddLink from "@/components/views/admin/component/main/links/component/add"
import { DeviceType, useDeviceStore } from "@/stores/device"

import LinkList from "../index.vue"

defineOptions({ name: "LinkListDetail" })
