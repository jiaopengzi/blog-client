<!--
 * FilePath    : blog-client-nuxt\src\components\views\md\component\md-customizer\index.vue
 * Author      : jiaopengzi
            ...
            <div class="md-customizer-panel">
                ...
                <div class="md-customizer-body">
                    <MdCustomizerConfigPanel
                        ...
                        @purge-local-images="emit('purge-local-images')"
                        @clear-local-images="emit('clear-local-images')"
                        @reset="resetAll"
                    />
...
import type { LocalImageUsage } from "@/utils/mdLocalImage"
...
const emit = defineEmits<{
    ...
    (e: "purge-local-images"): void
    (e: "clear-local-images"): void
}>()
