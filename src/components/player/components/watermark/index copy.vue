 ...
 * @LastEditTime : 2024-09-16 23:25:22
...
<template>
    <div class="container" ref="containerRef">
        <!-- 文字水印 -->
        <div v-if="isShowTextWatermark" ref="textWatermarkRef" class="watermark text-watermark">{{ textWatermarkContent
            }}</div>

        <!-- logo水印 -->
        <img v-if="isShowLogoWatermark" ref="logoWatermarkRef" class="watermark logo-watermark"
            :src="logoWatermarkLogoSrc" />
