 ...
 * @LastEditTime : 2023-11-25 15:13:29
 * @FilePath     : \blog-client\src\components\pc\HeaderPC.vue
 * @Description  : 头部 PC端
...
import HeaderPCNav from '@/components/pc/HeaderNavPC.vue'
import { ref, onBeforeMount } from 'vue'

import type { Ref } from 'vue'
import type { ScrollData } from '@/hooks/useScroll.types'
import { useScrollActions } from '@/hooks/useScrollActions'
import UserDropdown from '@/components/pc/UserDropdownPC.vue' // 导入 UserDropdown 组件
