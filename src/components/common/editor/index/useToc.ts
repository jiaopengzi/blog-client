 ...
 * @LastEditTime : 2023-12-20 22:10:26
 * @FilePath     : \blog-client\src\components\common\editor\index\useToc.ts
 * @Description  : toc 目录导航 hook
 * @Blog         : https://jiaopengzi.com
 * @Copyright    : Copyright (c) 2023 by jiaopengzi, All Rights Reserved.
 */
import type { Ref } from 'vue'
import type { CodemirrorRef, PreviewRef } from '@/components/common/editor/index/type'
