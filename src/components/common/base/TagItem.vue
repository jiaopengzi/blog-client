 ...
 * @LastEditTime : 2023-11-25 16:16:36
 * @FilePath     : \blog-client\src\components\common\base\TagItem.vue
 * @Description  : 标签元素
...
type Tag = { data: TagDataObj; color: TagColor }

type TagColor = { color: string; bgColor: string }
