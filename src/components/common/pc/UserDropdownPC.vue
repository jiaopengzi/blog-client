<!--
 * @Author       : jiaopengzi
 * @Date         : 2023-10-19 19:32:56
 * @LastEditors  : jiaopengzi
 * @LastEditTime : 2023-10-20 00:38:31
 * @FilePath     : \blog-client\src\components\common\pc\UserDropdownPC.vue
 * @Description  : 显示用户下拉菜单
...
import InitialAvatar from "@/components/common/InitialAvatar.vue"; // 导入 InitialAvatar 组件
