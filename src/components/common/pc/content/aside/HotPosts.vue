<!--
 * @Author       : jiaopengzi
 * @Date         : 2023-10-30 21:12:58
 * @LastEditors  : jiaopengzi
 * @LastEditTime : 2023-11-03 21:10:21
 * @FilePath     : \blog-client\src\components\common\pc\content\aside\HotPosts.vue
 * @Description  : 热门文章
...
<template>
  <div class="aside-item">
    <div class="title">
      <h2><span class="iconfont icon-hot"></span>热门文章</h2>
    </div>
    <div class="post-list">
...
const postDataObj: PostItemAsideObj = {
  ...
  title: '184_Python 在 Excel 和 Power BI 绘制堆积瀑布图这个标题很长有很多字怎么办电脑',
  date: '2023年3月15日',
  view: 1000,
}
