...
<!--
 * @Author       : jiaopengzi
 * @Date         : 2023-11-03 20:44:55
 * @LastEditors  : jiaopengzi
 * @LastEditTime : 2023-11-03 22:09:52
 * @FilePath     : \blog-client\src\components\common\pc\content\aside\Tags.vue
 * @Description  : 标签list
...
<template>
  <div class="aside-item">
    <div class="title">
      <h2><span class="iconfont icon-label"></span>文章标签</h2>
    </div>
    <div class="tag-box">
...
import type { TagDataObj } from '@/components/common/pc/base/tagItem.d'
import TagItem from '@/components/common/pc/base/TagItem.vue'
import { ref } from 'vue'
...
const items = ref<Array<TagDataObj>>([
  ...
  // { path: "/1", tagPostNum: 26, lablel: 'HR' }, { path: "/1", tagPostNum: 13, lablel: 'DAX Studio' },
  // { path: "/1", tagPostNum: 14, lablel: '热力图' },
  // { path: "/1", tagPostNum: 15, lablel: 'pbirs' },
  // { path: "/1", tagPostNum: 16, lablel: '帕累托' },
  // { path: "/1", tagPostNum: 17, lablel: '排名' },
