...
// 检查请求是否已经重试过
export const hasRetriedRequest = (req: AxiosRequestConfig) => retriedRequests.has(req)

// 标记请求为已重试
export const markRetriedRequest = (req: AxiosRequestConfig) => retriedRequests.add(req)
