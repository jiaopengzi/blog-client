/*
 * FilePath    : blog-client-nuxt\src\api\post\view.ts
 * Author      : jiaopengzi
...
export interface ViewPostRequest extends PaginationRequest {
    ...
    year?: number // 文章年份
    month?: number // 文章月份
    post_category_id?: string // 文章分类 ID
    post_category_slug?: string // 文章分类别名
    post_tag_id?: string // 文章标签 ID
...
// 查看文章
export function viewPostAPI(requestData: ViewPostRequest): ResPromise<Res<Pagination<PostResPagination>>> {
