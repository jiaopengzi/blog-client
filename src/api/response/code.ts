/*
 * FilePath    : blog-client-nuxt\src\api\response\code.ts
 * Author      : jiaopengzi
...
export enum ResponseCode {
    ...
    UserGenerateTokenFailed = 1009, // 生成 token 失败
    ...
    UserTokenInvalid = 1013, // 用户 token 无效
    UserTokenTypeWrong = 1014, // 用户 token 类型错误
    UserTokenExpired = 1015, // 用户 token 过期
    ...
    RedisSAddUserNameFailed = 1020, // redis 写入用户名集合失败
    RedisSAddUserEmailFailed = 1021, // redis 写入用户邮箱集合失败
    ...
    UserNameExistExcludingUserID = 1036, // 用户名已存在, 排除指定用户 ID
    UserNameNotExistExcludingUserID = 1037, // 用户名不存在, 排除指定用户 ID
    EmailExistExcludingUserID = 1038, // 邮箱已存在, 排除指定用户 ID
    EmailNotExistExcludingUserID = 1039, // 邮箱不存在, 排除指定用户 ID
    ...
    // 文章相关
    PostInsertSuccess = 2000, // 插入文章成功
    PostDeleteSuccess = 2001, // 删除文章成功
    PostUpdateSuccess = 2002, // 更新文章成功
    PostViewSuccess = 2003, // 查看文章成功
    PostCheckSlugNoExist = 2005, // 别名名称不存在
    PostCheckSlugNoExistExcludingID = 2007, // 别名名称不存在, 排除指定 ID
    PostViewByIDSuccess = 2008, // 根据 ID 查看文章成功
    ...
    PostTagCheckNameNoExistExcludingID = 2109, // 标签名称不存在, 排除指定 ID
    PostTagCheckSlugNoExistExcludingID = 2111, // 别名名称不存在, 排除指定 ID
    PostTagViewTopNSuccess = 2112, // 查看文章标签 TopN 成功
    ...
    PostCategoryCheckNameNoExistExcludingID = 2209, // 分类名称不存在, 排除指定 ID
    PostCategoryCheckSlugNoExistExcludingID = 2211, // 别名名称不存在, 排除指定 ID
    ...
    LinkCheckURLExistExcludingID = 2507, // 链接已经存在 (排除 ID)
    LinkCheckURLNotExistExcludingID = 2508, // 链接不存在 (排除 ID)
    ...
    MembershipRoleExistExcludingID = 2709, // 会员角色已存在, 排除指定 ID
    MembershipRoleNotExistExcludingID = 2710, // 会员角色不存在, 排除指定 ID
    ...
    CouponCodeExistExcludingID = 2809, // 优惠券已存在, 排除指定 ID
    CouponCodeNotExistExcludingID = 2810, // 优惠券不存在, 排除指定 ID
    CouponHasAvailableSuccess = 2811, // 获取是否有可用优惠券成功

    // 账号密钥相关
    AccountKeyInsertSuccess = 2900, // 插入账号密钥成功
    AccountKeyIsNone = 2901, // 账号密钥产品不存在
    AccountKeyDeleteSuccess = 2902, // 删除账号密钥成功
    ...
    AccountKeyItemDeleteSuccess = 2907, // 删除账号密钥明细成功
    ...
    OrderCancelSuccess = 5002, // 取消订单成功
    ...
    OrderCheckoutOrderIDMismatch = 5030, // 订单结算订单 ID 不匹配, 请重新下单
    ...
    DashboardGetPostVisitTopSuccess = 6104, // 获取面板文章访问排行成功
    ...
    BillingCenterGetAgreementSuccess = 6220, // 获取协议信息成功
    ...
    ConfirmAfterUploadBySignedUrlSuccess = 8107, // 使用签名 URL 上传文件后确认成功
    GetFileCountGroupByTypeSuccess = 8108, // 获取文件统计成功
    GetFilesSuccess = 8110, // 获取媒体信息成功
    FileDeleteSuccess = 8111, // 删除文件成功
    GetUploadFileUrlSuccess = 8113, // 获取上传文件 URL 成功
    ...
    LoginLogDeleteByIDsSuccess = 8502, // 通过 ID 删除登录日志成功
    LoginLogDeleteByDaySuccess = 8503, // 通过天数删除登录日志成功

    // 视频相关
    VideoNotFound = 8600, // 视频不存在
    GetVideoMainM3u8Success = 8601, // 获取视频主 M3u8 成功
    GetVideoM3u8Success = 8602, // 获取视频 M3u8 成功
    ...
    GetUserVideoProgressNoData = 8616, // 获取用户单一视频播放进度无数据
    VideoHasNoPay = 8617, // 视频未购买

    // 系统相关
    ValidatorRequestError = 9003, // 校验请求参数失败
    ClientIPTooManyRequests = 9006, // 客户端 IP 请求次数过多
    ClientIDTooManyRequests = 9007, // 客户端 ID 请求次数过多
    ...
    NoAdmin = 9020, // 不存在管理员
    GetStreamIDStatusSuccess = 9021, // 获取 streamID 状态成功
}
