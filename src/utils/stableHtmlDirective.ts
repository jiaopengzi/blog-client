/*
 * FilePath    : blog-client-nuxt\src\utils\stableHtmlDirective.ts
 * Author      : jiaopengzi
 * Blog        : https://jiaopengzi.com
 * Copyright   : Copyright (c) 2025 by jiaopengzi, All Rights Reserved.
 * Description : 增量更新 innerHTML 保留已加载图片的指令
 */
 ...
 */
export const stableHtmlDirective: ObjectDirective<HTMLElement, string> = {
    // 阶段 4: SSR 直出 innerHTML(与客户端 mounted 首帧一致, hydration 幂等, 无 mismatch)
