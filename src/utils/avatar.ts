/*
 * FilePath    : blog-client-nuxt\src\utils\avatar.ts
 * Author      : jiaopengzi
...
/**
 * @description: 获取头像地址, 优先使用 UserInfo.user.user_avatar, 如果没有则使用 UserInfo.user_wechat.avatar 或者 UserInfo.user_qq.avatar, 无则返回空字符串
 * @param userInfo 用户信息
 * @return 头像地址
 */
