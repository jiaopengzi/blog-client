<!--
 * @Author       : jiaopengzi
 * @Date         : 2025-01-08 15:18:01
 * @LastEditors  : jiaopengzi
 * @LastEditTime : 2025-01-08 15:35:08
 * @FilePath     : \blog-client\src\views\setup\re.vue
 * @Description  : 
 ...
 * @LastEditors  : jiaopengzi
 * @LastEditTime : 2025-01-08 15:15:43
...
<template>
    <div class="setup-page">
        ...
        >
            <div class="header-main">
                <a href="www.jiaopengzi.com" target="_blank">
                    <div class="logo">
                        <h2>
                            <img
                                src="https://jiaopengzi.com/wp-content/uploads/2021/10/220-50-1-YJ.png"
            ...
            <el-form-item label="主机地址" prop="email">
                <el-input v-model="setupForm.email" />
            </el-form-item>
            <el-form-item label="端口" prop="email">
                <el-input v-model="setupForm.email" />
            </el-form-item>
            <el-form-item label="数据库名" prop="email">
                <el-input v-model="setupForm.email" />
            </el-form-item>
            ...
            <el-form-item label="密码" prop="password">
                <el-input type="password" show-password v-model="setupForm.password" />
            </el-form-item>
            <el-form-item label="表格前缀" prop="email">
                <el-input v-model="setupForm.email" />
            </el-form-item>
            <el-form-item label="表格前缀" prop="email">
                <el-input v-model="setupForm.email" />
            ...
            <div class="btn-submit">
                <el-form-item>
                    <el-button type="primary" @click="submitForm(setupFormRef as FormInstance)"
                        >提交</el-button
                    >
                </el-form-item>
            </div>
