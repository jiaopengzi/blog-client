<template>
    <div class="example">
            ...
            <div class="config">
                ...
                <p>
                    ...
                    <select name="language" id="language" v-model="config.language">
                        <option :value="option" :key="option" v-for="option in ['javascript', 'html', 'json', 'markdown']">
                            {{ option }}
                        </option>
                    </select>
                </p>
        ...
        <div class="content">
            ...
            <codemirror class="codemirror" ref="cm" :autofocus="config.autofocus" :placeholder="config.placeholder"
                :indentWithTab="config.indentWithTab" :tabSize="config.tabSize" :disabled="config.disabled"
                :style="{ backgroundColor: config.backgroundColor }" :extensions="extensions"
                :phrases="config.phrases === 'en-us' ? {} : germanPhrases" v-model="code" @ready="handleReady"
                @change="consoleLog('change', $event)" @focus="consoleLog('focus', $event)"
...
import { Codemirror } from '@/pkg/codemirror/'
