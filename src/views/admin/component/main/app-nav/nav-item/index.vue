...
<template>
    ...
    >
        ...
        <el-form-item label="目的" prop="href">
            <el-input v-model="formDataResult.href" placeholder="导航目的链接或者路径" clearable />
        </el-form-item>
        ...
        <el-form-item label="预览">
            <el-menu>
                <el-menu-item>
                    <img v-if="!isInnerIcon" :src="formData.icon.src" :alt="formData.icon.alt" :style="formData.icon.style" class="icon-img" />
...
const { formData, rules, formWidth, labelWidth } = defineProps<{
