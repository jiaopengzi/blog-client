/**
 * FilePath    : blog-client-dev/src/pkg/codemirror/extension/theme/github/light.ts
 * Description : github light 主题
 */

import { tags as t } from "@lezer/highlight"
import { createTheme, type CreateThemeOptions } from "@uiw/codemirror-themes"
import { githubLightPreset } from "@/theme/presets/definitions/github-light"

const p = githubLightPreset.palette

export const githubLightSettings: CreateThemeOptions["settings"] = {
    background: p.bgPage,
...
export const githubLightStyles: CreateThemeOptions["styles"] = [
