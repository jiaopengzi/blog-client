/**
 * FilePath    : blog-client\src\pkg\codemirror\extension\theme\github\dark.ts
 * Author      : jiaopengzi
...
import { githubDarkPreset } from "@/theme/presets/definitions/github-dark"

const p = githubDarkPreset.palette

export const githubDarkSettings: CreateThemeOptions["settings"] = {
    background: p.bgPage,
...
export const githubDarkStyles: CreateThemeOptions["styles"] = [
...
export function githubDarkInit(options?: Partial<CreateThemeOptions>) {
    ...
    return createTheme({
        ...
        styles: [...githubDarkStyles, ...styles],
    })
}
