/**
 * FilePath    : blog-client-dev/src/pkg/codemirror/extension/theme/tokyonight/light.ts
 * Description : tokyonight light 主题
 */

import { tags as t } from "@lezer/highlight"
import { createTheme, type CreateThemeOptions } from "@uiw/codemirror-themes"
import { tokyonightDayPreset } from "@/theme/presets/definitions/tokyonight-day"

const p = tokyonightDayPreset.palette

export const tokyonightLightSettings: CreateThemeOptions["settings"] = {
    background: p.bgPage,
...
export const tokyonightLightStyles: CreateThemeOptions["styles"] = [
...
export function tokyonightLightInit(options?: Partial<CreateThemeOptions>) {
    const { theme = "light", settings = {}, styles = [] } = options || {}
    return createTheme({
        theme: theme,
        settings: {
            ...tokyonightLightSettings,
            ...settings,
        },
        styles: [...tokyonightLightStyles, ...styles],
    })
}
