/*
 * FilePath    : blog-client-nuxt\src\pkg\codemirror\extension\theme\vue\dark.ts
 * Author      : jiaopengzi
...
import { vueDarkPreset } from "@/theme/presets/definitions/vue-dark"

const p = vueDarkPreset.palette

export const vueDarkSettings: CreateThemeOptions["settings"] = {
    background: p.bgPage,
...
export const vueDarkStyles: CreateThemeOptions["styles"] = [
...
export function vueDarkInit(options?: Partial<CreateThemeOptions>) {
    ...
    return createTheme({
        ...
        styles: [...vueDarkStyles, ...styles],
    })
}

export const vueDark = vueDarkInit()
